"""Extended tests for rendering utilities - coverage gap filling.
...
class TestCreateMarkdownSummaryExtended:
    ...
    @patch("rendering.citations.enrich_if_enabled")
    @patch("rendering.markdown.CitationManager")
    def test_references_with_metadata(
        self, mock_cm_class, mock_enrich, tmp_path: Path
    ) -> None:
