"""Tests for llm/prompts.py - Prompt rendering and markdown stripping utilities."""
...
class TestRenderPromptValidation:
    ...
    def test_json_serialization_failure_falls_back_to_str(self) -> None:
        ...
        with patch("llm.prompts.json.dumps", side_effect=patched_dumps):
...
# ============================================================================
# strip_markdown_code_block (moved from text_cleaner)
# ============================================================================
