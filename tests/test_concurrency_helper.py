...
class TestConcurrencyHelper:
    ...
    def test_get_api_timeout_reads_config(self, monkeypatch) -> None:
    ...
    def test_get_rate_limits_parsing(self, monkeypatch) -> None:
    ...
    def test_get_rate_limits_default_on_invalid(self, monkeypatch) -> None:
